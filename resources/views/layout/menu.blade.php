<header>
    <nav class="back-black">
        <div class="nav-wrapper">
            <a class="brand-logo right shop" style="font-size:16px;padding-left:10px;">
                <i class="material-icons font-deft right" style="font-size:16px;">local_mall</i> Shopping Bag(0)
            </a>
            ...
            <ul class="left hide-on-med-and-down">
                ...
                <li><a href="mobile.html"><i class="material-icons left">exposure_plus_1</i>Fashion New</a></li>
            </ul>
        </div>
    </nav>
    <ul class="sidenav" id="mobile-demo">
        ...
        <li><a href="mobile.html">Fashion New</a></li>
    </ul>
