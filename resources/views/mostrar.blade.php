    ...
    <div class="layout-gallery gallery-top">
        <div class="card bg-white" style="padding:20px;">
            ...
            <div class="row">
                ...
                <div class="col s12 m6 l5" style="padding:10px;">
                    <div class="card">
                        ...
                        <div class="card-action">
                            <div class="row mb-0">
                                ...
                                <p class="col s12 m12 l6 left mt-0 mb-5"> Color: {{$producto->color}}</p>
                                <p class="col s12 m12 l6 right mt-0 mb-5"> Código: {{$producto->codigo}}</p>
                                <h4 class="col s12 m12 center mt-0 mb-5"> $ {{$producto->precioventa}}</h4>
                                <label class="col s12 m12 mt-0 mb-5">Disponibles</label>
                                @foreach ($inventario as $item)
                                <p class="col s6 m6 l3 right mt-0 mb-5">
                                ...
                                <form class="col s12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m12 l6 center">
                                            <button class="waves-effect waves-light btn green darken-1" type="button" onclick="DetallesAdd();" style="width:100%;">
                        ...
                        <li>
                            ...
                            <div class="collapsible-body"><span>Hasta 6 meses sin intereses con tarjetas participantes.</span>
                                <div class="row center">
                                    <div class="col s3 m2 l3" style="background-color:#546e7a;">
